...
SW_NEG_EDGE:
	...
	.global	SW_PULSE
	.align	2
	.type	SW_PULSE, %object
	.size	SW_PULSE, 4
SW_PULSE:
	.space	4
	.global	PULSE_STATE
	.align	2
	.type	PULSE_STATE, %object
	.size	PULSE_STATE, 4
PULSE_STATE:
	.space	4
	.global	SW_READ_ODD
...
FREQ_VAL:
	.word	125
	.global	INTENSITY_VAL
	.align	2
	.type	INTENSITY_VAL, %object
	.size	INTENSITY_VAL, 4
INTENSITY_VAL:
	.word	-10
	.global	MODE
	.bss
...
.LCFI28:
	.cfi_def_cfa_register 7
	.loc 1 566 0
	movw	r3, #:lower16:INTENSITY_VAL
	movt	r3, #:upper16:INTENSITY_VAL
	ldr	r3, [r3, #0]
	str	r3, [r7, #4]
	.loc 1 568 0
	movw	r3, #:lower16:SEG7_DIGIT1
